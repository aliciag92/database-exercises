...
#1c. Select only the following columns from the film table. #what?
SELECT *
FROM film;
...
FROM address
WHERE district IN ('California', 'England', 'Taipei', 'West');
...
SELECT * FROM payment 
WHERE payment_date BETWEEN "2005-05-25 00:00:00" AND "2005-05-27 23:59:59";
